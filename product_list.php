            ...
            <div class="card">
              <div class="card-header">
                ...
                <div class="d-flex justify-content-between align-items-center row pt-4 gap-6 gap-md-0">
                  ...
                  <a href="add_new_product.php"><div class="col-md-4 product_stock btn btn-primary">Add New Product</div></a>
                </div>
              </div>
              <div class="card-datatable table-responsive">
                  ...
                  <form id="searchForm" method="POST">
                                        <input type="text" id="searchID" placeholder="Enter Product Name">
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            function fetchClientData() {
                $.ajax({
                    url: 'fetch_data_product_ajax.php',  // URL to your PHP file
                    type: 'GET',
                    success: function (data) {
