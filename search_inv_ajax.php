...
// $IDS = $_POST['search'];
  $desql = mysqli_query($conn, "SELECT * FROM invList AS inv 
INNER JOIN clientlist AS ot ON inv.clientid = ot.cid 
WHERE inv.inv_genId LIKE '%{$search_value}%' 
OR ot.companyName LIKE '%{$search_value}%'");
