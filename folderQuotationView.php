...
$Sql = mysqli_query($conn, "SELECT * FROM quotationlist WHERE Clientid = '$iDD'");
        ...
        <table border="1" width="100%">
            <tr>
                <td width="35%" align="center"> 
                    <a href="print.php?id=<?php echo $SqlData['quotation_id']; ?>">
                        
                            <p class="btn btn-primary">View</p>
                        
                    </a>
                </td>
                <td width="10%" align="center"><p style="color:#000;"><?php echo $SqlData['quotation_gen_id']; ?></p></td>
                <td  width="25%" align="center">
                    <?php
                        $Clie = $SqlData['ClienNAmeID'];
                ...
                <td width="30%" align="center">
                    ...
                    <span style="color:#000;"><?php echo $SqlData['cdate']; ?></span>
