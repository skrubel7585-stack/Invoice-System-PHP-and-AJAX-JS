...
<div class="content-wrapper">
            ...
            <div class="card">
              <div class="card-header">
                ...
                <div class="d-flex justify-content-between align-items-center row pt-4 gap-6 gap-md-0">
                  ...
                  <a href="inv_add.php"><div class="col-md-4 product_stock btn btn-primary">Add Invoice</div></a>
                </div>
              </div>
    ...
    if(isset($_POST['submit'])){ ?>
                <table class="datatables-products table">
                  ...
                  <tbody>
<?php 
  $desql = mysqli_query($conn, "select * from invList where inv_genId = '$IDS' or invdate = '$IDS' or invid = '$IDS' or clientid = '$IDS' and status = '1'");
  $ctr = 1;
...
?>
                    <tr>
                        ...
                        <td>
                            <a href="invprint.php?id=<?php echo $data['invid']; ?>" class="btn btn-primary">Print</a> </td>
                             <td><a href="inv_edit.php?id=<?php echo $data['invid']; ?>" class="btn btn-primary">Edit</a>
...
<table class="datatables-products table">
                  ...
                  <tbody>
<?php 
  $desql = mysqli_query($conn, "select * from invList where status = '1'");
  $ctr = 1;
  foreach($desql as $data){
?>
                    <tr>
