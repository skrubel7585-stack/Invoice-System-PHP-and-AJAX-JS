...
<div class="content-wrapper">
    ...
    if(isset($_POST['submit'])){ ?>
                <table class="datatables-products table">
                  ...
                  <tbody>
<?php 
  $desql = mysqli_query($conn, "select * from quotationlist where quotation_gen_id = '$IDS' or cdate = '$IDS' or quotation_id = '$IDS' or Clientid = '$IDS' and status = '1'");
  $ctr = 1;
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="print.php?id=<?php echo $data['quotation_id']; ?>" class="btn btn-primary">Print</a>  </td>
                             <td><a href="quotation_edit.php?id=<?php echo $data['quotation_id']; ?>" class="btn btn-primary">Edit</a> 
...
<table class="datatables-products table">
                  ...
                  <tbody>
<?php 
  $desql = mysqli_query($conn, "select * from quotationlist where status = '1'");
  $ctr = 1;
  foreach($desql as $data){
?>
                    <tr>
