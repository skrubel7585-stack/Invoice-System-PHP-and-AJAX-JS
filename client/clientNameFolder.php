...
<?php
    $foldeSQL = mysqli_query($conn,"select * from contact_person");
    foreach($foldeSQL as $SQLData){
?>
  <a href="folderSubFolderView.php?id=<?php echo $SQLData['id'] ?>"><div class="folder"><p><?php echo $SQLData['name']; ?></p></div></a>
<?php } ?>
